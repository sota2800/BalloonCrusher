...
manager_spec = ["implementation_id", "manager", 
         "type_name",         "manager", 
...
# 
# </rtc-template>
class manager(OpenRTM_aist.DataFlowComponentBase):
    ...
    def onInitialize(self):
        ...
        self._CraneArmPortPort.registerConsumer("craneArm0", "CraneArmService", self.__craneArm0)
...
def managerInit(mgr):
    profile = OpenRTM_aist.Properties(defaults_str=manager_spec)
...
def MyModuleInit(manager):
    ...
    # Create a component
    comp = manager.createComponent("manager" + args)
